...
public final class KingdomClaimPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new ProtectionListener(kingdomManager, playerDataManager), this);
        ...
        KingdomCommand kingdomCommand = new KingdomCommand(this, kingdomManager, playerDataManager);
